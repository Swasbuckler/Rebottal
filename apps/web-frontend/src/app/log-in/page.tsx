...
function LogInPage() {
  ...
  return (
    <MaxWidthContainer>
      <div className="flex flex-col justify-center items-center gap-5 md:gap-15 my-14 md:my-20">
        <div className="flex flex-col md:flex-row items-center justify-center gap-2 w-full">
          ...
          <div className="flex flex-col gap-5 w-[calc(100%-1.5rem)] md:w-2/3 lg:w-2/5 xl:w-1/3 p-5 mx-6 md:ml-0 md:mr-6 bg-gray-100 dark:bg-gray-950 border-1 border-[#171717] dark:border-[#ededed] rounded-lg">
            <LogInForm />
        ...
        <div className="flex justify-center gap-2 w-[calc(100%-1.5rem)] md:w-[calc(100%-3rem)] lg:w-[calc(80%-1rem)] xl:w-[calc(66.666667%-1rem)] p-5 mx-6 bg-gray-100 dark:bg-gray-950 border-1 border-[#171717] dark:border-[#ededed] rounded-lg text-sm lg:text-base">
          New to Rebottal? 
          <Link 
