...
import SignInThirdPartyButton from "../auth/SignInThirdPartyButton";
  ...
  return (
    <MaxWidthContainer className={className}>
      <div className="flex flex-col justify-center items-center gap-5 my-14 md:my-20">
        <div className="flex flex-col md:flex-row items-center justify-center gap-2 w-full max-w-100 sm:max-w-150 md:max-w-225 lg:max-w-none">
        ...
        <div className="flex justify-center gap-2 w-[calc(100%-3rem)] md:w-[calc(100%-3rem)] lg:w-[calc(80%-1rem)] xl:w-[calc(66.666667%-1rem)] max-w-88 sm:max-w-138 md:max-w-213 lg:max-w-none p-5 mx-6 bg-gray-100 dark:bg-gray-950 border-1 border-[#171717] dark:border-[#ededed] rounded-lg text-sm lg:text-base">
